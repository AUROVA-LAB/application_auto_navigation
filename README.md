...
* Step 2: run blue_auto_online.launch or blue_auto_offline.launch (you can load the trajectory path in blue_auto_offline.yaml or blue_auto_online.yaml file).
